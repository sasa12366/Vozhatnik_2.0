...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    static final String TABLE_MYSIC = "Mysic";
    static final String TABLE_GAME = "Game";
    static final String TABLE_MINI = "Minimobile";
    static final String TABLE_ANALIS = "AnalysisDay";
    static final String DATE = "Date";
    static final String DESCRIPTION = "Description";
    static final String COLUMN_TEXT = "Text";
    static final String COLUMN_NAMEM = "Name";
    ...
    static final String TABLE_DETACHMENT = "Detachment";
